...
@Component({
  ...
  templateUrl: './dialog-personal-details-edit.component.html',
  styleUrls: ['./dialog-personal-details-edit.component.css'],
  providers: [
    {
      provide: DateAdapter,
...
export class DialogPersonalDetailsEditComponent implements OnInit {
  ...
  constructor(
    ...
    private dialogRef: MatDialogRef<DialogPersonalDetailsEditComponent>,
